...
namespace TeachMe.Migrations
{
    public partial class Initail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfJubot = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Jubot = table.Column<int>(nullable: false),
                    JubotPerHour = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Revieww = table.Column<string>(nullable: false),
                    StudentID = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsAndCourses", x => x.ID);
                    table.ForeignKey(
                        name: "FK_StudentsAndCourses_Course_CourseCourseID",
                        column: x => x.CourseCourseID,
                        principalTable: "Course",
                        principalColumn: "CourseID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentsAndCourses_Student_StudentStudentID",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("Reward");
            migrationBuilder.DropTable("StudentsAndCourses");
